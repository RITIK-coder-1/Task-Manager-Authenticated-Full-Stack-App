...
function HomeCard({ icon, heading, desc, styles = "" }) {
  return (
    <div
      className={`rounded-lg flex flex-col justify-center items-center bg-white shadow-xl px-2 w-36 h-44 gap-3  sm:w-48 sm:h-56 sm:gap-5 md:w-56 md:h-64 md:gap-7 lg:w-66 lg:h-74 xl:w-92 xl:h-88 xl:gap-8 hover:border hover:border-gray-300 ${styles}`}
    >
      <FontAwesomeIcon
        icon={icon}
      ...
      <div className="flex flex-col justify-center items-center xl:gap-3">
        <h5 className="text-center text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
          {heading}
        </h5>
