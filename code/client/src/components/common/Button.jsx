...
function Button({
  ...
  return (
    <button
      className={`bg-blue-600 font-bold rounded-3xl p-2 h-7 text-white text-center flex justify-center items-center cursor-pointer font-sans hover:bg-blue-700 ${styles} ${bgColor} ${width}`}
      onClick={onClick}
      type={type}
      disabled={disabled}
      title={content}
